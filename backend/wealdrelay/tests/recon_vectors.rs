...
//!
//! `specs/backend/contracts/wire/vectors/recon.json` is generated by
//! `scripts/fixture-log.sh --recon-vectors`, which compiles `Sources/Sync`. So the
//! expected values in it come from the client's implementation, and this suite is the
//! relay reproducing them.
//!
